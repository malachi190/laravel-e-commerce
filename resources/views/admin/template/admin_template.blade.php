...
<html lang="en">
  <head>
    <title>One-Stop Shop Admin Panel</title>
    <meta charset="utf-8">
    ...
    <div class="adminx-container">
        ...
        <ul class="navbar-nav d-flex justify-content-end mr-2">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link avatar-with-name" id="navbarDropdownMenuLink" data-toggle="dropdown" href="#">
              <img src="{{asset('/images/'.auth()->user()->image)}}" class="d-inline-block align-top" alt="">
            </a>
      ...
      <div class="adminx-sidebar expand-hover push">
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-nav-item">
            <a href="{{route('main.category')}}" class="sidebar-nav-link">
              <span class="sidebar-nav-icon">
          ...
          <li class="sidebar-nav-item">
            ...
            <ul class="sidebar-sub-nav collapse" id="example">
              <li class="sidebar-nav-item">
                <a href="{{route('add_product')}}" class="sidebar-nav-link">
              ...
              <li class="sidebar-nav-item">
                <a href="{{route('all_products')}}" class="sidebar-nav-link">
                  <span class="sidebar-nav-abbr">
                    VA
                  </span>
                  <span class="sidebar-nav-name">
