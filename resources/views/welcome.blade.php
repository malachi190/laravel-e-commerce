							...
							<div class="products-slick" data-nav="#slick-nav-1">
								...
								<div class="product">
									<div class="product-img">
										<img src="{{asset('/product_images/'. $product->product_image)}}" alt="" class="w-auto image-fluid" height="250">
									...
									<div class="add-to-cart">
										<a href="{{route('product_details', $product->id)}}" class="add-to-cart-btn btn">view details</a>
									</div>
								</div>
								<!-- /product -->
								@endforeach
...
<!-- HOT DEAL SECTION -->
<div id="hot-deal" class="section" style="position: relative; top: 4rem;">
	<!-- container -->
	<div class="container">
		<!-- row -->
		<div class="row">
					...
					<div class="products-tabs">
						...
						<div id="tab2" class="tab-pane fade in active">
							<div class="products-slick" data-nav="#slick-nav-2">
								...
								<div class="product">
									<div class="product-img">
										<img src="{{asset('product_images/'. $product->product_image)}}" alt="" class="image-fluid" height="250">
										<div class="product-label">
											<span class="sale">-30%</span>
											<span class="new">NEW</span>
										</div>
									...
									<div class="product-body">
										<p class="product-category">{{$product->product_category}}</p>
										<h3 class="product-name"><a href="#">{{$product->product_title}}</a></h3>
										<h4 class="product-price">${{$product->product_price}} <del class="product-old-price">${{$product->product_discount_price}}</del></h4>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
